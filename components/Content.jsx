  ...
  return (
    <div className="px-4 py-16 container mx-auto md:px-24 lg:px-8 lg:py-20">
      <div className="w-full px-4">
          ...
          <div className="w-full lg:w1/2">
            <div className="lg:pr-10">
              ...
              <p className="mb-6 text-gray-900">
                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae explicabo. Sed ut perspiciatis unde omnis iste natus error sit voluptatem totam rem
        ...
        <div className="lg:mt-0 w-full lg:w-1/2 mt-12">
          <Image className="rounded shadow-lg" src="/my.png" alt="/" width={300} height={300} />
        </div>
        </div>
      </div>
    </div>
